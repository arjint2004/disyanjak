...
class Messages extends MY_Controller {
	...
	{
		$this->db->query("TRUNCATE TABLE inbox");
		$this->db->query("TRUNCATE TABLE outbox");
		$this->db->query("TRUNCATE TABLE outbox_multipart");
		$this->db->query("TRUNCATE TABLE sentitems");
		$this->db->query("TRUNCATE TABLE user_inbox");
		$this->db->query("TRUNCATE TABLE user_outbox");
		$this->db->query("TRUNCATE TABLE user_sentitems");
	}
	/**
	 * Compose
	 *
